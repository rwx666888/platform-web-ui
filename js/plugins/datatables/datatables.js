///<jscompress sourcefile="jquery.dataTables.js" />
/*! DataTables 1.10.12
...
;
///<jscompress sourcefile="dataTables.bootstrap.js" />
...
///<jscompress sourcefile="dataTables.select.js" />
 ...
 * 
 * @edit : lianglei 增加规则白名单、延迟处理单击事件,阻止双击时行选中状态
 */
(function( factory ){
	if ( typeof define === 'function' && define.amd ) {
		// AMD
...
function enableMouseSelection ( dt )
{
	...
	body
		...
		.on( 'click.dtSelect', selector, function ( e ) {
		    /* @lianglei 增加规则白名单、延迟处理单击事件,阻止双击时行选中状态*/
		    clearTimeout(cus_timer_);
			var items = dt.select.items();
			var idx;

			// If text was selected (click and drag), then we shouldn't change
			// the row's selected state
			if ( (window.getSelection && window.getSelection().toString() && !$(e.target).hasClass('select-checkbox')) || $(e.target).hasClass('no-Sel-obj')) {
				return;
			}
			
			cus_timer_ = setTimeout(function(){
		...
		on( 'dblclick.dtSelect', selector, function ( e ) {
		    clearTimeout(cus_timer_);
		} );
...
;
///<jscompress sourcefile="dataTables.rowsGroup.js" />
...
*/
;
///<jscompress sourcefile="dataTables.fixedColumns.js" />
/*! FixedColumns 3.2.2
...
;
///<jscompress sourcefile="dataTables.rowReorder.js" />
/*! RowReorder 1.1.2
